	...
	public void testeEmail() {
		...
		try {
			...
			stringBuilderTextoEmail.append(
					"<a target= \"_blank\" href=\"www.google.com.br\" style=\"color:#2525a7;padding: 14px 25px; text-align:center;text-decoration: none;display:inline-block;border-radius:30px; font-size:20px; font-family:courier; border:3px solid green;background-color:#99DA39;\">Acessar Portal </a>");
